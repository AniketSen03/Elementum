  ...
  return (
    <section id="offer" className="relative pt-24 sm:pt-32 pb-16">
      <div className="mx-auto max-w-content px-6 sm:px-8 lg:px-10">
        ...
        <ul className="font-satoshi mt-14 divide-y divide-ink/10 border-t border-ink/10">
          {offers.map((offer) => (
            <li key={offer.id}>
              <a
                href="#contact"
              ...
              >
                <p className="w-full sm:w-56 shrink-0 text-xs sm:text-lg text-black leading-snug">
                  {offer.eyebrow}
                </p>
                <h3 className="flex-1 font-gerbil font-semibold text-2xl sm:text-3xl lg:text-4xl transition-colors group-hover:text-coral">
                  {offer.title}
                </h3>
