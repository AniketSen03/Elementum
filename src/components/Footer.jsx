...
function FooterColumn({ title, links }) {
  return (
    <div>
      <h3 className="font-gerbil text-lg mb-4">{title}</h3>
...
export default function Footer() {
  return (
    <footer className="relative bg-[#D7EEDD] pt-14 pb-8">
      <div className="mx-auto max-w-content px-6 sm:px-8 lg:px-10">
        <div className="font-satoshi grid grid-cols-2 md:grid-cols-4 gap-y-10 gap-x-6">
          <FooterColumn title="Company" links={footerLinks.company} />
          <FooterColumn title="Terms & Policies" links={footerLinks.terms} />
          <FooterColumn title="Follow Us" links={footerLinks.follow} />

          <div>
            <h3 className="font-gerbil text-lg mb-4">Contact Us</h3>
            <address className="not-italic text-sm text-black space-y-2.5 leading-relaxed">
              <p>
        ...
        <p className="mt-6 text-center text-xs font-satoshi text-black">
